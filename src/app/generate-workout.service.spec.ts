...
import { BASE_WORKOUT_OBJ, DEFAULT_NUM_CYCLES, GREEN_COLOR, PREPARE_INTERVAL, REST_INTERVAL, WORK_INTERVAL } from './constants';
...
describe('GenerateWorkoutService', () => {
  ...
  describe("getWorkout", () => {
    it("should generate default workout object", () => {
      let expectedWorkout: GeneratedWorkout = Object.assign({}, BASE_WORKOUT_OBJ);
      expectedWorkout = {
        ...expectedWorkout, ...{
