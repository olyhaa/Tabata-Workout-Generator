...
import { BASE_WORKOUT_OBJ, GREEN_COLOR, PREPARE_INTERVAL, REST_INTERVAL, WORK_INTERVAL } from './constants';
...
describe('WorkoutStatsService', () => {
  ...
  it('should calculate total time', () => {
    let workout: GeneratedWorkout = Object.assign({}, BASE_WORKOUT_OBJ);
    workout = {
      ...workout, ...{
    ...
    expect(service.getTotalTime(workout)).toBe(service.getTime(163));
  });
